...
# This script generates `/lib/Web/ChromeLogger/Null.pm`.
...
my $source = <<'...';
# =========================================================================
# THIS FILE IS AUTOMATICALLY GENERATED BY `author/generate_null.pl`.
...
open my $fh, '>', "$FindBin::Bin/../lib/Web/ChromeLogger/Null.pm";
print $fh $source;
